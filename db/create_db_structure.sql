...
-- Started on 2017-05-19 16:13:25
...
--
-- TOC entry 1614 (class 1255 OID 18627)
-- Name: get_object_id_by_access_key(uuid); Type: FUNCTION; Schema: api; Owner: postgres
--
...
ALTER FUNCTION api.get_object_id_by_access_key(i_obj_access_key uuid, OUT o_obj_id integer) OWNER TO postgres;

--
-- TOC entry 3896 (class 0 OID 0)
-- Dependencies: 1614
-- Name: FUNCTION get_object_id_by_access_key(i_obj_access_key uuid, OUT o_obj_id integer); Type: COMMENT; Schema: api; Owner: postgres
--
...
--
-- TOC entry 1613 (class 1255 OID 18607)
...
--
-- TOC entry 3755 (class 2604 OID 16403)
...
--
-- TOC entry 3756 (class 2604 OID 18590)
...
--
-- TOC entry 3761 (class 2606 OID 16408)
...
--
-- TOC entry 3764 (class 2606 OID 18596)
...
--
-- TOC entry 3762 (class 1259 OID 18606)
...
--
-- TOC entry 3758 (class 1259 OID 18626)
...
--
-- TOC entry 3759 (class 1259 OID 16409)
...
--
-- TOC entry 3765 (class 1259 OID 18608)
...
--
-- TOC entry 3766 (class 2606 OID 18597)
...
-- Completed on 2017-05-19 16:13:25
